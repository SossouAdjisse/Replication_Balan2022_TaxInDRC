...
***********
	...
	lab var roof_final "Roof quality"
		...
		esttab  r1 r2 r3 r4 r5 r6 r7 r8 using "${reploutdir}/chiefs_info_payease_baseline.tex", ///
...
***********
		...
		esttab r11 r21 r31 r41 r51 r61 r71 r81 using "${reploutdir}/chiefs_info_wtp_baseline.tex", ///
		replace label b(%9.3f) p(%9.3f) booktabs ///
