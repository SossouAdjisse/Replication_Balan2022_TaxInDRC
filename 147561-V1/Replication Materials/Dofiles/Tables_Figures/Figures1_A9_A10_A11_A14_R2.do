...
gen chef_tenure_hi  = chef_tenure > 10
	...
	global covs_basic = "age_prop sex_prop employed salaried work_gov main_tribe"	
...
//##########################################################################
	...
	eststo: oprobit `depvar' $covs_basic $chief_chars i.stratum  i.time_FE_tdm_2mo_CvCLI if t_cli==1,cluster(a7)	
	...
	global testvars "govmorale_ind paytax_ind econ_ind p_pay_ease_graph unobs_ind house_quality_new"
		...
		* Leave-one-out mean
		...
		preserve
			...
			graph export "${reploutdir}/chars_visited_R2.pdf",replace
		restore
...
*********************
		...
		preserve
			...
			graph export "${reploutdir}/chars_PEXHQ_R2.pdf",replace
