...
***********
	...
	* Compliance - Periphery
	eststo r1: reg taxes_paid t_l i.stratum i.time_FE_tdm_2mo_CvL if inlist(tmt,1,2) & house==1, cl(a7)
	...
	* Compliance - MM
	eststo r2: reg taxes_paid t_l i.stratum i.time_FE_tdm_2mo_CvL if inlist(tmt,1,2) & house==2, cl(a7)
	...
	* House Quality - Compliance
	...
	eststo r3: reg hq_y t_l i.house i.stratum i.time_FE_tdm_2mo_CvL a7_hq_y if inlist(tmt,1,2) & taxes_paid==1, cl(a7)
	...
	* Income - Compliance
	...
	eststo r4: reg inc_mo_avg t_l i.house i.stratum i.time_FE_tdm_2mo_CvL a7_inc_mo_avg if inlist(tmt,1,2) & taxes_paid==1, cl(a7)
	...
	* Liquidity - Compliance
	eststo r5: reg econ_ind t_l i.house i.stratum i.time_FE_tdm_2mo_CvL a7_econ_ind if inlist(tmt,1,2) & taxes_paid==1, cl(a7)
	su econ_ind if t_c==1 & time_FE_tdm_2mo_CvL!=. & taxes_paid==1
	estadd local Mean=abs(round(`r(mean)',.001))
	estadd scalar Observations = `e(N)'
	estadd scalar Clusters = `e(N_clust)'

	esttab r1 r2 r3 r4 r5 using "${reploutdir}/main_incidence_results.tex", ///
