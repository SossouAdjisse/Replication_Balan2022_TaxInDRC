...
***********
	...
	* Month FE - Compliance
	eststo r1: reg taxes_paid i.tmt i.house i.stratum i.time_FE_tdm_2mo_CvCLI if inlist(tmt,1,3), cl(a7)
	...
	* Month FE - Revenues
	eststo r2: reg taxes_paid_amt i.tmt i.house i.stratum i.time_FE_tdm_2mo_CvCLI if inlist(tmt,1,3), cl(a7)
		ritest tmt _b[3.tmt], reps(1000) seed(125) cluster(a7) strata(stratum) nodots: `e(cmdline)'
		matrix pvalues = r(p) 
		mat colnames pvalues = 3.tmt  
		est restore r2 
	...
	* Month FE - Visited
	eststo r3: reg visit_post_carto i.tmt i.house i.stratum i.time_FE_tdm_2mo_CvCLI if inlist(tmt,1,3), cl(a7)
		ritest tmt _b[3.tmt], reps(1000) seed(125) cluster(a7) strata(stratum) nodots: `e(cmdline)'
		matrix pvalues = r(p) 
		mat colnames pvalues = 3.tmt  
		est restore r3 
	...
	* Month FE - Visits
	eststo r4: reg nb_visit_post_carto i.tmt i.house i.stratum i.time_FE_tdm_2mo_CvCLI if inlist(tmt,1,3), cl(a7)
		ritest tmt _b[3.tmt], reps(1000) seed(125) cluster(a7) strata(stratum) nodots: `e(cmdline)'
		matrix pvalues = r(p) 
		mat colnames pvalues = 3.tmt  
		est restore r4
	...
	* Month FE - Compliance Conditional on Visited
	eststo r5: reg taxes_paid i.tmt i.house i.stratum i.time_FE_tdm_2mo_CvCLI if inlist(tmt,1,3) & visit_post_carto==1, cl(a7)
		ritest tmt _b[3.tmt], reps(1000) seed(125) cluster(a7) strata(stratum) nodots: `e(cmdline)'
		matrix pvalues = r(p) 
		mat colnames pvalues = 3.tmt  
		est restore r5 
	...
	* Month FE - Compliance CvLvCLI
	eststo r6: reg taxes_paid i.tmt t_l i.house i.stratum i.time_FE_tdm_2mo_CvLvCLI if inlist(tmt,1,2,3), cl(a7)
		ritest tmt _b[3.tmt], reps(1000) seed(125) cluster(a7) strata(stratum) nodots: `e(cmdline)'
		matrix pvalues = r(p) 
		mat colnames pvalues = 3.tmt  
		est restore r6 
	...
	esttab r1 r2 r3 r4 r5 r6 using "${reploutdir}/main_centralwinfo_results_baseline.tex", ///
