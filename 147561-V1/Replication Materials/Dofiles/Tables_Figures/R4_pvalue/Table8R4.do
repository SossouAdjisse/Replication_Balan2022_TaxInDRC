...
*/
			...
			* latex output 
		esttab  r1 r2 r3 r4 r5 r6 r7 r8 using "${reploutdir}/chiefs_info_payease8R4_pv.tex", ///
		...
		* csv output 
		esttab  r1 r2 r3 r4 r5 r6 r7 r8 using "${reploutdir}/chiefs_info_payease8R4_pv.csv", ///
...
*/
	      ...
	      * Latex Output 
		esttab r11 r21 r31 r41 r51 r61 r71 r81 using "${reploutdir}/chiefs_info_wtp8R4_pv.tex", ///
		replace label b(%9.3f) p(%9.3f) booktabs ///
		...
		nogaps nonotes compress
			...
			* csv output
		esttab r11 r21 r31 r41 r51 r61 r71 r81 using "${reploutdir}/chiefs_info_wtp8R4_pv.csv", ///
		replace label b(%9.3f) p(%9.3f) ///
		keep (willingness p_willingness walls_final roof_final ravine_final) ///
		order(willingness p_willingness walls_final roof_final ravine_final) ///
		cells("b(fmt(a3))"  "p(fmt(a3) par)" "pvalues(fmt(%9.3f) par([ ]))") ///
