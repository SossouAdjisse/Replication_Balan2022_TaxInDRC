...
gen chef_tenure_hi  = chef_tenure > 10
	...
	global covs_willingness "sex_prop  chef_fam salaried col_view_gov_nbhd_hi tmt_2016"
...
***********
	...
	preserve
		...
		rename  (p_pay_ease p_willingness)(p_linear_cc_pay_ease p_linear_cc_willingness)
	...
	esttab using "${reploutdir}/chiefs_info_payease8R2_top5.tex", ///
...
* CSV Format 
	esttab using "${reploutdir}/chiefs_info_payease8R2_top5.csv", ///
	...
	***********
	...
	esttab using "${reploutdir}/chiefs_info_wtp8R2_top5.tex", ///
	replace label b(%9.3f) se(%9.3f) booktabs ///
...
* CSV Format 
	esttab using "${reploutdir}/chiefs_info_wtp8R2_top5.csv", ///
	replace label b(%9.3f) se(%9.3f) ///
	keep (willingness p_willingness walls_final roof_final ravine_final) ///
	order(willingness p_willingness walls_final roof_final ravine_final) ///
	scalar(Clusters Mean) sfmt(0 3) ///
