...
drop _merge
	...
	* Month FE - Compliance CvLvCLI
	...
	esttab r1 r2 r3 r4 r5 r6 r7 using "${reploutdir}/main_centralwinfo_results7R2_pv.tex", ///
...
* CSV Format 
	esttab r1 r2 r3 r4 r5 r6 r7 using "${reploutdir}/main_centralwinfo_results7R2_pv.csv", ///
