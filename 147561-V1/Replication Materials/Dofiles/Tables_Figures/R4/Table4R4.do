...
*/
	...
	* Month FE - Compliance - House FE - Condition Exempt
	...
	esttab using "${reploutdir}/main_compliance_results4R4.tex", ///
	...
	* CSV Format 
	esttab using "${reploutdir}/main_compliance_results4R4.csv", ///
...
*/
	...
	* Month FE - Revenues - House FE - Condition Exempt
	...
	esttab using "${reploutdir}/main_revenues_results4R4.tex", ///
	replace label b(%9.3f) se(%9.3f) booktabs ///
	keep (t_l) ///
	order(t_l) ///
	scalar(Clusters Mean) sfmt(0 3 3) ///
	...
	* CSV Format 
	esttab using "${reploutdir}/main_revenues_results4R4.csv", ///
	replace label b(%9.3f) se(%9.3f) ///
	keep (t_l) ///
	order(t_l) ///
	scalar(Clusters Mean) sfmt(0 3 3) ///
