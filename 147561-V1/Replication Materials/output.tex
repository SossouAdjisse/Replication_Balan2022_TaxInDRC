...
\begin{table}[H]
	...
	\usebox{\tablebox}\\[1ex]
	\parbox{6in}{\footnotesize \textit{Notes}: This table reports the results of table 8 using randomization inference in the  regressions of panels A and B. The prediction stage is the same as in the table 8 with regard to method and variables. There are two p-values reported:  between parenthesis is the p-value for the original equation and the one in square brackets is for the randomization  inference.}
\end{table}
