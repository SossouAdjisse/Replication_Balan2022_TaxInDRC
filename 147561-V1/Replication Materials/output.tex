...
\begin{table}[H]
	...
	\centering
	\small{\input{Output/main_compliance_resultsRbaseline.tex}}
	\small{\input{Output/main_revenues_resultsRbaseline.tex}}
	\usebox{\tablebox}\\[1ex]
	\parbox{6in}{\footnotesize \textit{Notes}: Table 4 Replicated .}
\end{table}
...
\begin{table}[H]
	\textbf{\caption*{\label{Table_CvCLI_Test}  Table \ref{Table_CvCLI} $\rightarrow$ Using analysis\_data\_Sossou1.dta}}
	\centering
	\begin{lrbox}{\tablebox}
		
		\resizebox{14cm}{!}{
			\input{Output/main_centralwinfo_resultsTest.tex}
		}
	\end{lrbox}
	\usebox{\tablebox}\\[1ex]
	\parbox{6in}{\footnotesize \textit{Notes}: }
...
\begin{table}[H]
	\textbf{\caption*{\label{Table_CvCLI_Replicated2}  Table \ref{Table_CvCLI} $\rightarrow$ Replicated Replacing House FE by Trust the Chief}}
	\centering
	\begin{lrbox}{\tablebox}
