...
\begin{table}[H]
	\textbf{\caption *{\label{Table_CvL_Compliance_edited_Rbaseline} Table 4 Replicated: $\rightarrow$ Restricted to Baseline Only + Randomization Inference }}
	\centering
	\small{\input{Output/main_compliance_results_baseline.tex}}
	\small{\input{Output/main_revenues_results_baseline.tex}}
	\usebox{\tablebox}\\[1ex]
...
\begin{table}[H]
	\textbf{\caption*{\label{Table_CvL_Compliance_edited_Replicated} Table 4 Replicated:  $\rightarrow$  Randomization Inference}}
	\centering
	\small{\input{Output/main_compliance_resultsR.tex}}
	\small{\input{Output/main_revenues_resultsR.tex}}
	\usebox{\tablebox}\\[1ex]
...
\begin{table}[H]
	...
	\begin{lrbox}{\tablebox}
		\scalebox{0.8}{
			\input{Output/main_visits_results_baseline.tex}
		}
	\end{lrbox}
	\usebox{\tablebox}\\[1ex]
...
\begin{table}[H]
	...
	\begin{lrbox}{\tablebox}
		\scalebox{0.8}{
			\input{Output/main_visits_resultsR.tex}
		}
	\end{lrbox}
	\usebox{\tablebox}\\[1ex]
...
\begin{table}[H]
	...
	\begin{lrbox}{\tablebox}
		...
		\resizebox{14cm}{!}{
			\input{Output/main_centralwinfo_results_baseline.tex}
		}
	\end{lrbox}
	\usebox{\tablebox}\\[1ex]
	\parbox{6in}{\footnotesize \textit{Notes}: }
...
\begin{table}[H]
	...
	\begin{lrbox}{\tablebox}
		...
		\resizebox{14cm}{!}{
			\input{Output/main_centralwinfo_resultsR.tex}
		}
	\end{lrbox}
	\usebox{\tablebox}\\[1ex]
	\parbox{6in}{\footnotesize \textit{Notes}: }
...
\begin{table}[H]
	\textbf{\caption*{Table 8 Replicated:  $\rightarrow$  Controlling for Chiefs Characteristics \label{chiefs_info_payeaseR5}}}
	\centering
	\centerfloat
...
\begin{table}[H]
	\textbf{\caption*{Table 8 Replicated: $\rightarrow$  Restricted to Only Baseline Respondents\label{validation_cli_control_baseline}}}
	\centering
	\centerfloat
...
\begin{table}[H]
	...
	\centering
	\centerfloat
	\tiny{\input{Output/chiefs_info_payeaseR.tex}} \newline 
	\tiny{\input{Output/chiefs_info_wtpR.tex}}
	\usebox{\tablebox}\\[1ex]
	\parbox{6in}{\footnotesize \textit{Notes}: }
\end{table}
...
\begin{table}[H]
	\textbf{\caption*{Table \ref{validation_cli_control} $\rightarrow$  Oprobit + More Controls + Chiefs Average Characteristics \label{validation_cli_control_R4}}}
	\centering
	\centerfloat
