...
\begin{table}[H]
	\textbf{\caption *{\label{Table_CvL_Compliance_edited_Rbaseline} Table 4R2: $\rightarrow$ Restricted to Baseline Only + Randomization Inference }}
	\centering
...
\end{table}
 ...
 \begin{table}[H]
 	\textbf{\caption*{\label{bribesviews5R1} Table 5R1:  $\rightarrow$ Add p-value, Bribe Amounst (Midline and Endline)} }
 	\centering
...
\begin{table}[H]
	...
	\begin{lrbox}{\tablebox}
		\resizebox{15cm}{!}{
			\input{Output/main_incidence_resultsR.tex}
		}
	\end{lrbox}
	\usebox{\tablebox}\\[1ex]
	\parbox{6in}{\footnotesize \textit{Notes}: }
