...
%	\centering
%	\small{\input{Output/main_compliance_resultsR3.tex}}
%	\small{\input{Output/main_revenues_resultsR3.tex}}
%	\usebox{\tablebox}\\[1ex]
...
\begin{table}[H]
	\textbf{\caption*{Table 8LCR1: $\rightarrow$  Replication of  \ref{validation_cli_control_LC} with Randomization Inference Approach \label{validation_cli_control_LCR1}}}
	\centering
	\centerfloat
...
\begin{table}[H]
	...
	\centering
	\centerfloat
	\tiny{\input{Output/chiefs_info_payeaseR1.tex}} \newline 
	\tiny{\input{Output/chiefs_info_wtpR1.tex}}
	\usebox{\tablebox}\\[1ex]
