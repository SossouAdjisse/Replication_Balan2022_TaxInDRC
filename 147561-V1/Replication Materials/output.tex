...
\clearpage
%	\tiny{\input{Output/BaseAdminCompliance.tex}}
\begin{table}[H]
	\centering
	\caption{Power - Baseline Admin - Compliance}
	\begin{adjustbox}{max width=\textwidth}
		\begin{threeparttable}
			\input{Output/BaseAdminCompliance_m.tex}
			\begin{tablenotes}[flushleft]
				\item\hspace{-.25em}\input{Output/BaseAdminCompliance_m_note.tex}
			\end{tablenotes}
		\end{threeparttable}
	\end{adjustbox}
\end{table}
...
\begin{table}[H]
	\centering
	\caption{Power - Central Analysis data - Compliance}
	\begin{adjustbox}{max width=\textwidth}
		\begin{threeparttable}
			\input{Output/AnalDCentralCompliance_m.tex}
			%			\begin{tablenotes}[flushleft]
				%				\item\hspace{-.25em}\input{Tables/BFA/BFA_balance_new_note.tex}
				%			\end{tablenotes}
		\end{threeparttable}
	\end{adjustbox}
\end{table}
...
\begin{table}[H]
	\centering
	\caption{Power - Control Analysis data - Compliance}
	\begin{adjustbox}{max width=\textwidth}
		\begin{threeparttable}
			\input{Output/AnalDControlCompliance_m.tex}
			%			\begin{tablenotes}[flushleft]
				%				\item\hspace{-.25em}\input{Tables/BFA/BFA_balance_new_note.tex}
				%			\end{tablenotes}
		\end{threeparttable}
...
\begin{table}[H]
	\centering
	\caption{Power - Baseline, Central and Control - Revenues}
	\begin{adjustbox}{max width=\textwidth}
		\begin{threeparttable}
			\input{Output/AnalDAllRevenues_m.tex}
			%			\begin{tablenotes}[flushleft]
				%				\item\hspace{-.25em}\input{Tables/BFA/BFA_balance_new_note.tex}
				%			\end{tablenotes}
		\end{threeparttable}
...
\begin{center}
%	\textbf{\caption*{\label{Table_CvL_Compliance_edited_Replicated} }}
	\tiny{\input{Output/campaign_components.tex}}
\end{center}
...
\begin{table}[H]
	\textbf{\caption*{\label{Table_CvL_Compliance_edited_4R1} Table 4R1:  $\rightarrow$  Randomization Inference}}
	\centering
	\small{\input{Output/main_compliance_results4R1.tex}}
	\small{\input{Output/main_revenues_results4R1.tex}}
	\usebox{\tablebox}\\[1ex]
	\parbox{6in}{\footnotesize \textit{Notes}: Table 4 repliacted  using randomization inference on the sample that the authors used. There are two p-values reported. The first one in parenthesis is from the simple regression. The second one  in square brackets is from the randomization inference estimation using the ritest command in Stata. The RI was repeated 1000 with seed 125. All other controls are the same as the ones used by the authors in the original table. The dofile of this table is name \enquote{Table4RI.do}}
\end{table}

%\begin{table}[H]
%	\textbf{\caption*{\label{Table_CvL_Compliance_edited_Replicated} Table 4R1:  $\rightarrow$  Randomization Inference}}
%	\centering
%	\small{\input{Output/main_compliance_resultsR1.tex}}
%	\small{\input{Output/main_revenues_resultsR1.tex}}
%	\usebox{\tablebox}\\[1ex]
%	\parbox{6in}{\footnotesize \textit{Notes}: Table 4 repliacted  using randomization inference on the sample that the authors used. There are two p-values reported. The first one in parenthesis is from the simple regression. The second one  in square brackets is from the randomization inference estimation using the ritest command in Stata. The RI was repeated 1000 with seed 125. All other controls are the same as the ones used by the authors in the original table. The dofile of this table is name \enquote{Table4RI.do}}
%\end{table}
...
\begin{table}[H]
	\textbf{\caption *{\label{Table_CvL_Compliance_edited_Rbaseline_4R2} Table 4R2: $\rightarrow$ Controlling for chiefs characteristics}}
	\centering
	\small{\input{Output/main_compliance_results4R2.tex}}
	\small{\input{Output/main_revenues_results4R2.tex}}
	\usebox{\tablebox}\\[1ex]
...
\begin{table}[H]
	\textbf{\caption *{\label{Table_CvL_Compliance_edited_Rbaseline_4R4} Table 4R4: $\rightarrow$ Restricting to Baseline}}
	\centering
	\small{\input{Output/main_compliance_results4R4.tex}}
	\small{\input{Output/main_revenues_results4R4.tex}}
	\usebox{\tablebox}\\[1ex]
	\parbox{6in}{\footnotesize \textit{Notes}: Table 4 repliacted}
\end{table}

%\begin{table}[H]
%	\textbf{\caption *{\label{Table_CvL_Compliance_edited_Rbaseline_4R2} Table 4R2: $\rightarrow$ Restricted to Baseline Only + Randomization Inference }}
%	\centering
%	\small{\input{Output/main_compliance_resultsR2.tex}}
%	\small{\input{Output/main_revenues_resultsR2.tex}}
%	\usebox{\tablebox}\\[1ex]
%	\parbox{6in}{\footnotesize \textit{Notes}: Table 4 repliacted by restricting to respondents in the baseline sample. There are two p-values reported. The first one in parenthesis is from the simple regression. The second one  in square brackets is from the randomization inference estimation using the ritest command in Stata. The RI was repeated 1000 with seed 125. All other controls are the same as the ones used by the authors in the original table. The dofile of this table is name \enquote{Table4Rbaseline.do}}
%\end{table}

%\begin{table}[H]
%	\textbf{\caption *{\label{Table_CvL_Compliance_edited_Rbaseline} Table 4R2 new: $\rightarrow$ Controlling for Trust in Cheifs (Restricted to Baseline Only) }}
%	\centering
%	\small{\input{Output/main_compliance_results4R2_new.tex}}
%	\small{\input{Output/main_revenues_results4R2_new.tex}}
%	\usebox{\tablebox}\\[1ex]
%	\parbox{6in}{\footnotesize \textit{Notes}: }
%	% Table 4 repliacted by restricting to respondents in the baseline sample. There are two p-values reported. The first one in parenthesis is from the simple regression. The second one  in square brackets is from the randomization inference estimation using the ritest command in Stata. The RI was repeated 1000 with seed 125. All other controls are the same as the ones used by the authors in the original table. The dofile of this table is name \enquote{Table4Rbaseline.do}
%\end{table}

%\begin{table}[H]
%	\textbf{\caption*{\label{Table_CvL_Compliance_edited_R2} Table 4 Replicated:  $\rightarrow$ Controling for Trust in Chief}}
%	\centering
%\resizebox{14cm}{!}{\input{Output/main_compliance_resultsR2.tex}}
%\resizebox{14cm}{!}{\input{Output/main_revenues_resultsR2.tex}}
%	\usebox{\tablebox}\\[1ex]
%	\parbox{6in}{\footnotesize \textit{Notes}: Table 4 repliacted  on the sample that the authors used by controlling \enquote{ Trust in Chief}.  All other controls are the same as the ones used by the authors in the original table. The dofile of this table is name \enquote{Table4R2.do}}
%\end{table}
%
%
%\begin{table}[H]
%	\textbf{\caption*{\label{Table_CvL_Compliance_edited_R3_old} Table 4R3 (old version): \ref{Table_CvL_Compliance_edited} $\rightarrow$ Controling for Trust in Chief, and Local x Trust Chief}}
%	\centering
%	\small{\input{Output/main_compliance_resultsR3_old.tex}}
%	\small{\input{Output/main_revenues_resultsR3_old.tex}}
%	\usebox{\tablebox}\\[1ex]
%	\parbox{6in}{\footnotesize \textit{Notes}: Table 4 Replicated .}
%\end{table}
%
%\begin{table}[H]
%	\textbf{\caption*{\label{Table_CvL_Compliance_edited_R3_new} Table 4R3 (new version): \ref{Table_CvL_Compliance_edited} $\rightarrow$ Controling for Trust in Chief, and Local x Trust Chief}}
%	\centering
%	\small{\input{Output/main_compliance_resultsR3_new.tex}}
%	\small{\input{Output/main_revenues_resultsR3_new.tex}}
%	\usebox{\tablebox}\\[1ex]
%	\parbox{6in}{\footnotesize \textit{Notes}: Table 4 Replicated .}
%\end{table}
%
%
% \begin{table}[H]
%	\textbf{\caption*{\label{Table_CvL_Compliance_edited_R4} Table 4R4:  \ref{Table_CvL_Compliance_edited} $\rightarrow$ Using Central, and Controling for Trust in Chief, and Local x Trust Chief}}
%	\centering
%	\small{\input{Output/main_compliance_resultsR4.tex}}
%	\small{\input{Output/main_revenues_resultsR4.tex}}
%	\usebox{\tablebox}\\[1ex]
%	\parbox{6in}{\footnotesize \textit{Notes}: Table 4 Replicated .}
%\end{table}
%
% \begin{table}[H]
%	\textbf{\caption*{\label{Table_CvL_Compliance_edited_R4_new} Table 4R4 (new version ):  \ref{Table_CvL_Compliance_edited} $\rightarrow$ Using Central, and Controling for Trust in Chief, and Local x Trust Chief}}
%	\centering
%	\small{\input{Output/main_compliance_resultsR4_new.tex}}
%	\small{\input{Output/main_revenues_resultsR4_new.tex}}
%	\usebox{\tablebox}\\[1ex]
%	\parbox{6in}{\footnotesize \textit{Notes}: Table 4 Replicated .}
%\end{table}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\end{table}
 ...
 Table 5 Replicated: Bribe Amount
 \begin{table}[H]
 	\textbf{\caption*{\label{bribesviews5R1} Table 5R1:  $\rightarrow$ Add Randomized Inference p-value } }
 	\centering
 	\input{Output/assessment_bribes5R1.tex}
 	\input{Output/attitudes5R1.tex}
 	\usebox{\tablebox}\\[1ex]
 	\parbox{6in}{\footnotesize \textit{Notes}: }
 \end{table}

%\begin{table}[H]
%\textbf{\caption*{\label{bribesviewsR} Table 5R1:  $\rightarrow$ Add p-value, Bribe Amounst (Midline and Endline)} }
%\centering
%\input{Output/assessment_bribesR.tex}
%\input{Output/attitudes.tex}
%\usebox{\tablebox}\\[1ex]
%\parbox{6in}{\footnotesize \textit{Notes}: }
%\end{table}
...
\begin{table}[H]
	\textbf{\caption*{\label{Table_CvL_Visits_edited_6R1} Table 6R1: $\rightarrow$ Randomization Inference}}
	\centering
	\begin{lrbox}{\tablebox}
		\scalebox{0.8}{
			\input{Output/main_visits_results6R1.tex}
		}
	\end{lrbox}
	\usebox{\tablebox}\\[1ex]
	\parbox{6in}{\footnotesize \textit{Notes}: Table \ref{Table_CvL_Visits_edited_Replicated} replicated using the ritest command in Stata .}
\end{table}

%\begin{table}[H]
%	\textbf{\caption*{\label{Table_CvL_Visits_edited_R1} Table 6R1: $\rightarrow$ Randomization Inference}}
%	\centering
%	\begin{lrbox}{\tablebox}
%		\scalebox{0.8}{
%			\input{Output/main_visits_resultsR1.tex}
%		}
%	\end{lrbox}
%	\usebox{\tablebox}\\[1ex]
%	\parbox{6in}{\footnotesize \textit{Notes}: Table \ref{Table_CvL_Visits_edited_Replicated} replicated using the ritest command in Stata .}
...
\begin{table}[H]
	\textbf{\caption*{\label{Table_CvL_Visits_edited6R2} Table 6R2: $\rightarrow$ Restricted to Baseline Sample }}
	\centering
	\begin{lrbox}{\tablebox}
		\scalebox{0.8}{
			\input{Output/main_visits_results6R2.tex}
		}
	\end{lrbox}
	\usebox{\tablebox}\\[1ex]
...
%\begin{table}[H]
%	\textbf{\caption*{\label{Table_CvL_Visits_editedR2} Table 6R2: $\rightarrow$ Restricted to Baseline Sample }}
%	\centering
%	\begin{lrbox}{\tablebox}
%		\scalebox{0.8}{
%			\input{Output/main_visits_resultsR2.tex}
%		}
%	\end{lrbox}
%	\usebox{\tablebox}\\[1ex]
%	\parbox{6in}{\footnotesize \textit{Notes}: Table \ref{Table_CvL_Visits_edited} .}
...
% Table 6 Replicated: Controlling for Trust In Chief
...
\begin{table}[H]
	\textbf{\caption*{\label{Table_CvCLI_Replicated}  Table 7R1: $\rightarrow$ Randomization Inference}}
	\centering
	\begin{lrbox}{\tablebox}
		
		\resizebox{14cm}{!}{
			\input{Output/main_centralwinfo_results7R1.tex}
		}
	\end{lrbox}
	\usebox{\tablebox}\\[1ex]
	\parbox{6in}{\footnotesize \textit{Notes}: }
...
%		
%		\resizebox{14cm}{!}{
%			\input{Output/main_centralwinfo_resultsR1.tex}
%		}
%	\end{lrbox}
%	\usebox{\tablebox}\\[1ex]
%	\parbox{6in}{\footnotesize \textit{Notes}: }
...
\begin{table}[H]
	\textbf{\caption*{\label{Table_CvCLI_Replicated2}  Table 7R2: $\rightarrow$ Controlling for Trust the Chief}}
	\centering
	\begin{lrbox}{\tablebox}
		
		\resizebox{14cm}{!}{
			\input{Output/main_centralwinfo_resultsR2.tex}
		}
	\end{lrbox}
	\usebox{\tablebox}\\[1ex]
	\parbox{6in}{\footnotesize \textit{Notes}: }
...
\begin{table}[H]
	\textbf{\caption*{\label{Table_CvCLI_Replicated3}  Table 7R3: $\rightarrow$ Interacting CLI and Local with Trust the Chief}}
	\centering
	\begin{lrbox}{\tablebox}
		
		\resizebox{14cm}{!}{
			\input{Output/main_centralwinfo_resultsR3.tex}
		}
	\end{lrbox}
	\usebox{\tablebox}\\[1ex]
	\parbox{6in}{\footnotesize \textit{Notes}: }
...
\begin{table}[H]
	\textbf{\caption*{\label{main_centralwinfo_results_baseline}  Table 7R4: $\rightarrow$ Restricted to Baseline Sample}}
	\centering
	\begin{lrbox}{\tablebox}
		
		\resizebox{14cm}{!}{
			\input{Output/main_centralwinfo_resultsR4.tex}
		}
	\end{lrbox}
	\usebox{\tablebox}\\[1ex]
	\parbox{6in}{\footnotesize \textit{Notes}: }
...
\begin{table}[H]
	\textbf{\caption*{Table 8R1: $\rightarrow$  Randomization Inference  \label{validation_cli_control_R1}}}
	\centering
	\centerfloat
	\tiny{\input{Output/chiefs_info_payease8R1.tex}} \newline 
	\tiny{\input{Output/chiefs_info_wtp8R1.tex}}
	\usebox{\tablebox}\\[1ex]
	\parbox{6in}{\footnotesize \textit{Notes}: This table is a replication of the results in table 8 using randomization inference. The prediction stage is the same as in the table 8 with regard to method and variables. There are two p-values reported:  between parenthesis is the p-value for the original linear regression  and the one in square brackets is from the randomization  inference.}
\end{table}
...
\begin{table}[H]
	\textbf{\caption*{Table 8LCC: $\rightarrow$  Linear Regression + Chiefs Characteristics  \label{validation_cli_control_LC}}}
	\centering
	\centerfloat
	\tiny{\input{Output/chiefs_info_payeaseLC.tex}} \newline 
	\tiny{\input{Output/chiefs_info_wtpLC.tex}}
	\usebox{\tablebox}\\[1ex]
	\parbox{6.8in}{\footnotesize \textit{Notes}: This table is a replication of the results in table 8 using linear regression + chiefs characteristics. Chiefs characteristics is a set of above-the-median binaries which includes age, number of  possessions, education, how far do chiefs live to their tax collection compounds, chiefs trust in the national  and the provincial governments, trust in tax ministry, chiefs tenure greater than 10 years, dynasty status (whether chiefs have inherited the position from a family memenber),  the treatment status of 2016 etc. Everything elese at the prediction stage is the same as in the table 8 with regard to method and variables. There are two p-values reported:  between parenthesis is the p-value for the original linear regression  and the one in square brackets is from the randomization  inference.}
\end{table}

\begin{table}[H]
	\textbf{\caption*{Table 8LCR1: $\rightarrow$  Replication of  \ref{validation_cli_control} with Randomization Inference Approach \label{validation_cli_control_LCR1}}}
	\centering
	\centerfloat
	\tiny{\input{Output/chiefs_info_payeaseLC_R1.tex}} \newline 
	\tiny{\input{Output/chiefs_info_wtpLC_R1.tex}}
	\usebox{\tablebox}\\[1ex]
	\parbox{6in}{\footnotesize \textit{Notes}: This table is a replication of the results in Table \ref{validation_cli_control_LC} using Randomization inference approach. Everything else is the same as in Table \ref{validation_cli_control_LC}. There are two p-values reported:  between parenthesis is the p-value for the original linear regression  and the one in square brackets is from the randomization  inference.}
\end{table}

\begin{table}[H]
	\textbf{\caption*{Table 8R0: $\rightarrow$  Willingness and its prediction on the same scale 1 to 3  \label{validation_cli_control_R0}}}
	\centering
	\centerfloat
	\tiny{\input{Output/chiefs_info_payeaseR0.tex}} \newline 
	\tiny{\input{Output/chiefs_info_wtpR0.tex}}
	\usebox{\tablebox}\\[1ex]
	\parbox{6in}{\footnotesize \textit{Notes}: This table reports the results of table 8}
\end{table}

%\begin{table}[H]
%	\textbf{\caption*{Table Predict: $\rightarrow$  \label{predict}}}
%	\centering
%	\centerfloat
%	\tiny{\input{Output/PredictPerformance.tex}} 
%	\usebox{\tablebox}\\[1ex]
%	\parbox{6in}{\footnotesize \textit{Notes}:}
%\end{table}

%\begin{center}
\small{\input{Output/PredictPerformance_m.tex}} 
%\end{center}
...
\begin{table}[H]
	\textbf{\caption*{Table 8R2: $\rightarrow$  Using Oprobit to predict the ease and willingness to pay \label{validation_cli_control_R2}}}
	\centering
	\centerfloat
	\tiny{\input{Output/chiefs_info_payeaseR2.tex}} \newline 
	\tiny{\input{Output/chiefs_info_wtpR2.tex}}
	\usebox{\tablebox}\\[1ex]
	\parbox{6in}{\footnotesize \textit{Notes}:  This table reports the results of table 8 using ordered probit at the prediction stage. Everything else is the same as in the code that generated table 8.}
\end{table}

\begin{table}[H]
	\textbf{\caption*{Table 8R3: $\rightarrow$  Using Oprobit + Chiefs Controls \label{validation_cli_control_R3}}}
	\centering
	\centerfloat
	\tiny{\input{Output/chiefs_info_payeaseR3.tex}} \newline 
	\tiny{\input{Output/chiefs_info_wtpR3.tex}}
	\usebox{\tablebox}\\[1ex]
	\parbox{6in}{\footnotesize \textit{Notes}: This table reports the results of table 8 using ordered probit and controlling for chiefs characteristics at the prediction stage. Chiefs characteristics is a set of above-the-median binaries which includes trust in provincial government, trust in tax ministry, number of possessions, age, chiefs tenure greater than 10 years, etc. Everything else is the same as in the code that generated table 8.}
\end{table}


\begin{table}[H]
	\textbf{\caption*{Table 8R4: $\rightarrow$   Oprobit + More Controls + Chiefs Average Characteristics \label{validation_cli_control_R4}}}
	\centering
	\centerfloat
	\tiny{\input{Output/chiefs_info_payeaseR4.tex}} \newline 
	\tiny{\input{Output/chiefs_info_wtpR4.tex}}
	\usebox{\tablebox}\\[1ex]
	\parbox{6in}{\footnotesize \textit{Notes}: }
\end{table}

%\begin{table}[H]
%	\textbf{\caption*{Table 8R5: $\rightarrow$  Controlling for Chiefs Characteristics \label{chiefs_info_payeaseR5}}}
%	\centering
%	\centerfloat
%	\tiny{\input{Output/chiefs_info_payeaseR5.tex}} \newline 
%	\tiny{\input{Output/chiefs_info_wtpR5.tex}}
%	\usebox{\tablebox}\\[1ex]
%	\parbox{6in}{\footnotesize \textit{Notes}: This is a replication of Table 8 where we controlled for walls quality, roof quality, erosion threat, and chiefs characteristics in columns 1 and 2. The chiefs characteristics consist of  above-median dummies for  age,  possessions,  education,  remoteness,  tenure, dynsty, trust in government, and more. The dofile for this table is named \enquote{Table8R5.do}
%	}
%\end{table}

\begin{table}[H]
	\textbf{\caption*{Table 8R5: $\rightarrow$  Restricted to Only Baseline Respondents\label{validation_cli_control_baseline}}}
	\centering
	\centerfloat
	\tiny{\input{Output/chiefs_info_payease_baseline.tex}} \newline 
	\tiny{\input{Output/chiefs_info_wtp_baseline.tex}}
	\usebox{\tablebox}\\[1ex]
	\parbox{6in}{\footnotesize \textit{Notes}: }
\end{table}
...
\begin{table}[H]
	...
	\centering
	\centerfloat
	\tiny{\input{Output/chiefs_info_payeaseR6.tex}} \newline 
	\tiny{\input{Output/chiefs_info_wtpR6.tex}}
	\usebox{\tablebox}\\[1ex]
	\parbox{6in}{\footnotesize \textit{Notes}: }
\end{table}
...
\begin{table}[H]
	\textbf{\caption*{Table 8R4: $\rightarrow$  Restricted to Only Baseline Respondents\label{validation_cli_control_baseline}}}
	\centering
	\centerfloat
	\tiny{\input{Output/chiefs_info_payease8R4.tex}} \newline 
	\tiny{\input{Output/chiefs_info_wtp8R4.tex}}
	\usebox{\tablebox}\\[1ex]
	\parbox{6in}{\footnotesize \textit{Notes}: }
\end{table}
...
\begin{table}[H]
	\textbf{\caption*{\label{Table_CvL_Distribution_Incidence_Replicated} Table9R1: $\rightarrow$ Table \ref{Table_CvL_Distribution_Incidence}    Replicated using RI}}
	\centering
	\begin{lrbox}{\tablebox}
		\resizebox{15cm}{!}{
			\input{Output/main_incidence_results9R1.tex}
		}
	\end{lrbox}
	\usebox{\tablebox}\\[1ex]
	\parbox{6in}{\footnotesize \textit{Notes}: }
...
\begin{table}[H]
	...
	\centering
	\tiny{\input{Output/compl_CvL_results_timeimbalR.tex}}
	\tiny{\input{Output/rev_CvL_results_timeimbal.tex}}
	\usebox{\tablebox}\\[1ex]
...
\small{\input{Output/rev_results_saturated.tex}}
\usebox{\tablebox}\\[1ex]
...
\begin{table}[H]
	...
	\centering
	\resizebox{16cm}{!}{\input{Output/compl_results_saturatedR1.tex}}
	\resizebox{15cm}{!}{\input{Output/rev_results_saturatedR1.tex}}
	\usebox{\tablebox}\\[1ex]
	\parbox{6in}{\footnotesize \textit{Notes}: .}
\end{table}
...
\begin{table}[H]
	...
	\centering
\resizebox{16cm}{!}{\input{Output/compl_results_controlsR1.tex}}
	\resizebox{14cm}{!}{\input{Output/rev_results_controlsR1.tex}}
	\usebox{\tablebox}\\[1ex]
	\parbox{6in}{\footnotesize \textit{Notes}: .}
\end{table}

\begin{table}[H]
	\textbf{\caption*{\label{Table_CvL_RobustControls_R1_new} Table 7R1 (new version) \ref{Table_CvL_RobustControls} $\rightarrow$ Using Trust in Chief }}
	\centering
	\resizebox{16cm}{!}{\input{Output/compl_results_controlsR1_new.tex}}
	\resizebox{14cm}{!}{\input{Output/rev_results_controlsR1_new.tex}}
	\usebox{\tablebox}\\[1ex]
	\parbox{6in}{\footnotesize \textit{Notes}: .}
\end{table}
...
\begin{table}[ht]
	...
	\begin{lrbox}{\tablebox}
		\resizebox{16cm}{!}{
			\input{Output/tablechefknowindexR1.tex}
		}
	\end{lrbox}
	\usebox{\tablebox}\\[1ex]
...
\begin{table}[ht]
	...
	\begin{lrbox}{\tablebox}
		\resizebox{16cm}{!}{
			\input{Output/dist_collectorsR1.tex}
		}
	\end{lrbox}
	\usebox{\tablebox}\\[1ex]
	\parbox{6in}{\footnotesize \textit{Notes}: \ref{predictiveness_discussion}.}
...
\begin{table}[ht]
	...
	\centerfloat
	\resizebox{16cm}{!}{	\input{Output/collectors_C_near_homeR1.tex}}\\
	\resizebox{16cm}{!}{	\input{Output/collectors_C_CLI_near_homeR1.tex}}
	\usebox{\tablebox}\\[1ex]
	\parbox{6in}{\footnotesize \textit{Notes}:  \ref{predictiveness_discussion}.}
\end{table}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{table}[ht]
	...
	\centerfloat
	\begin{lrbox}{\tablebox}
		\input{Output/pay_registrationR.tex}
	\end{lrbox}
	\usebox{\tablebox}\\[1ex]
...
\begin{table}[H]
	...
	\begin{lrbox}{\tablebox}
		\resizebox{15cm}{!}{
			\input{Output/flier_effects_tax_timeFER.tex}
		}
	\end{lrbox}
	\usebox{\tablebox}\\[1ex]
...
\begin{table}[H]
	...
	\centering
	\tiny{\input{Output/flier_PanelA_timeFER.tex}}
	\tiny{\input{Output/flier_PanelB_timeFER.tex}}
	\tiny{\input{Output/flier_PanelC_timeFER.tex}}
	\tiny{\input{Output/flier_PanelD_timeFER.tex}}
	\tiny{\input{Output/flier_PanelE_timeFER.tex}}
	\usebox{\tablebox}\\[1ex]
	\parbox{6in}{\footnotesize \textit{Notes}: Replicated.}
\end{table}
